...
To represent the complete information including all the strains, we decided to represent the gene scores in a heatmap for each experimental condition (**Figure 2A**). These were plotted using R (see SCRIPT).
